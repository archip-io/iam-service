...
import static com.archipio.iamservice.util.ApiUtils.RESET_PASSWORD_SUBMIT_SUFFIX;
...
public class ResetPasswordController {
  ...
  @PostMapping(RESET_PASSWORD_SUBMIT_SUFFIX)
  public ResponseEntity<Void> submitRegistration(
      @Valid @RequestBody ResetPasswordSubmitDto resetPasswordSubmitDto) {
